            ...
            <div class="flex h-[500px] ">
                <div class="w-[600px] rounded-l-lg bg-gray-800">
                    <div class="my-20 mx-10">
                        <h1 class="text-5xl font-bold text-gray-200">Join Medisina for Free</h1>
                        <div class="w-[200px] h-[9px] my-7 bg-emerald-500"></div>
                        <p class="text-gray-200 pr-10">Join us and Discover the trusted and high-quality medicines all
                            over
                            the world.</p>
                    </div>
                </div>
