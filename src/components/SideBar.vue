...
import HomeToggle from '@/components/ui/toggle/HomeToggle.vue';
...
<template>
    <div>
        <div class="font-montserrat flex h-screen border-r">
            <div class="w-64 bg-gray-950 overflow-hidden shadow-xl">
